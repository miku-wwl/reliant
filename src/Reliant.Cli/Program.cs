...
{
    Console.WriteLine("Diagnostics collection not yet implemented.");
...
jobsInspect.SetAction(_ =>
{
    Console.WriteLine("Job inspection not yet implemented.");
    return Task.CompletedTask;
});
var jobsRetry = new Command("retry", "Retry a failed job");
jobsRetry.SetAction(_ =>
{
    Console.WriteLine("Job retry not yet implemented.");
    return Task.CompletedTask;
});
...
deadletterList.SetAction(_ =>
{
    Console.WriteLine("Dead-letter listing not yet implemented.");
    return Task.CompletedTask;
});
var deadletterReplay = new Command("replay", "Replay a dead-letter item");
deadletterReplay.SetAction(_ =>
{
    Console.WriteLine("Dead-letter replay not yet implemented.");
    return Task.CompletedTask;
});
